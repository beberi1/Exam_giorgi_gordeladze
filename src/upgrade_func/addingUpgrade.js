...
export async function  addUpgrade(object, setUpgrades) {
    ...
    if (object.length === 3 && object[2].numberOfUpgrades >= 3){
    ...
    if (object.length === 4 && object[3].numberOfUpgrades >= 5){
    ...
    if (object.length === 5 && object[4].numberOfUpgrades >= 10){
    ...
    if (object.length === 7 && object[6].numberOfUpgrades >= 20){
    ...
    if (object.length === 8 && object[7].numberOfUpgrades >= 10){
